package com.example.latihanmopro.Common;
...
public class DataSma {
    public static String[][] array = new String[][] {
            ...
            {"SMA Negeri 3 Purwakarta", "JL. LETKOL KADIR NO. 15", "https://drive.google.com/uc?export=view&id=1jxumpU8giY7uX-2aiq1f2uJN-MRlF98Y", "20217363", "A", "geo:-6.542172, 107.439169", "1987"},
